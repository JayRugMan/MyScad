...
wall_count = 3;     // number of walls for strength

// Light Dimensions
light_diameter = 81.942; // diameter of the light
...
cover_thickness_lines = 2;    // thickness of the cover in lines
cover_thickness_side = cover_thickness_lines * line_width; // thickness of the cover in mm
cover_thickness_top = (cover_thickness_lines * layer_height) - layer_height; // thickness of the cover in mm
...
cover_height = light_height + cover_thickness_top; // height of the cover

// Main Cover
module light_cover() {
    difference() {
        // Outer Shell
        cylinder(h = cover_height, d = cover_diameter, center = true);
        // Inner Cavity
        translate([0, 0, cover_thickness_top])
            cylinder(h = light_height, d = cover_inner_diameter, center = true);
    }
}
